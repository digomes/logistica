    ...
    <tr>
        ...
        <td>
            ...
            <label for="ProductEmbalagem">Sim</label>-->
             <?php echo $this->Form->input('ReversesProduct.'.$key.'.embalagem', array('type' => 'checkbox', 'label' => 'Sim'));?>
        </td>
        <td>
            <?php 
    ...
    <tr>
        ...
        <th>
          <?php
            ...
            echo $this->Html->link('Limpar', array('controller' => 'products', 'action'=>'empty_cart'), array('class' => 'btn btn-warning'));
          ?>
        </th>
    </tr>
   </tbody> 
...
<div id="addProduct" class="modal hide fade modal-admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-static="true">
  ...
  <div class="modal-body">
      <iframe src="" style="zoom:0.60" width="99.5%" height="650px"  frameborder="0"></iframe>
  </div>
</div>
