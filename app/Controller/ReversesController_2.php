 ...
 */
	...
	public function correction($id = null) {
		...
		/*$reverses = $this->Reverse->find('all',
                ...
                $_serialize = 'reverses';
                $_delimiter = ';';
                $_header = array('Numero da Coleta', 'Numero NF Posto', 'Serie NF', 'Volume', 'Valor NF', 'Nome do Usuário', 'Nome do Posto', 'Status', 'Centro de Custo', 'Numero de SO', 'Data Solicitação', 'Observação', 'NF de Origem');
                $_extract = array('Reverse.id', 'Reverse.invoice', 'Reverse.serie', 'Reverse.quantity', 'Reverse.amount', 'User.name', 'User.username', 'Status.name', 'Cost.name', 'Reverse.so', 'Reverse.created', 'Reverse.observation', 'Reverse.reverse');
